...
import com.shopmodule.home.uitls.VirtualkeyboardHeight;
import com.shopmodule.shoppingcart.utils.CartProvider;
import com.shopmodule.shoppingcart.view.NumberAddSubView;
...
//            wbGoodInfoMore.loadUrl(Constants.GOODSINFO_URL + product_id);
            wbGoodInfoMore.loadUrl("http://wap.cwhisky.com");
